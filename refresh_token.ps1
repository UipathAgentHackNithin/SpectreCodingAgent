...
# Step 3: update .env with new refresh token and access token (no BOM)
...
# Step 4: update Orchestrator asset with AllowDirectApiAccess
$headers = @{
...
Write-Host "Asset ID: $ASSET_ID" -ForegroundColor Cyan
